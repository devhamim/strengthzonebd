        	...
        	<div class="row clearfix">
                ...
                <div class="content-side col-lg-8 col-md-12 col-sm-12">
                	...
                	<div class="blog-single">
						<div class="inner-box">
							<div class="image">
								<img src="{{ asset('frontend') }}/images/resource/news-8.jpg" alt="" />
							</div>
							<div class="lower-content">
								...
								<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudanm, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. </p>
								<div class="two-column">
									<div class="row clearfix">
										<div class="column col-lg-6 col-md-6 col-sm-12">
											<div class="image">
												<img src="{{ asset('frontend') }}/images/resource/news-11.jpg" alt="" />
											</div>
										</div>
										<div class="column col-lg-6 col-md-6 col-sm-12">
											<div class="image">
												<img src="{{ asset('frontend') }}/images/resource/news-12.jpg" alt="" />
											</div>
										</div>
									</div>
								</div>
								...
								<div class="video-box style-two">
									<figure class="video-image">
										<img src="{{ asset('frontend') }}/images/resource/news-13.jpg" alt="">
									</figure>
								...
								<div class="author-box">
									<div class="author-inner">
										<div class="thumb"><img src="{{ asset('frontend') }}/images/resource/author-6.jpg" alt=""></div>
								...
								<div class="comments-area">
									...
									<div class="comment-box">
										<div class="comment">
											<div class="author-thumb">
												<img src="{{ asset('frontend') }}/images/resource/author-7.jpg" alt="">
									...
									<div class="comment-box reply-comment">
										<div class="comment">
											<div class="author-thumb">
												<img src="{{ asset('frontend') }}/images/resource/author-8.jpg" alt="">
												<a class="theme-btn reply-btn" href="#"> Reply</a>
											</div>
								...
								<div class="comments-form">
									...
									<div class="default-form style-two">
										...
										<!-- Default Form -->
										<form method="post" action="#" id="contact.html">
											<div class="row clearfix">
