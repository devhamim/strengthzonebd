                ...
                <input type="hidden" name="id" value="{{ $banners->id }}">
                    <div class="row g-3">
                        {{-- <div class="col-12">
                            ...
                            <input type="text" name="title" class="form-control form-control-sm" value="{{ $banners->title }}">
                        </div> --}}
                        {{-- <div class="col-12">
                            <label class="form-label">Description</label>
                            <textarea name="description" class="form-control form-control-sm">{{ $banners->description }}</textarea>
                        </div> --}}
                        ...
                        <div class="col-12">
                            ...
                            <div class="my-3">
                                <img width="100" id="blah" src="{{ asset('uploads/banner') }}/{{ $banners->image }}" alt="">
                            </div>
                        </div>
                        <div class="col-12">
                            ...
                            <select name="status" class="form-control form-control-sm" id="">
                                ...
                                <option value="2" {{ $banners->status == 2 ? 'selected' : '' }}>Deactive</option>
                            </select>
                        </div>
